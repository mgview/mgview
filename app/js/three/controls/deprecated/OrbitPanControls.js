...
THREE.OrbitPanControls = function ( object, domElement ) {
    ...
    this.move = function ( delta ) {
        var x_axis = new THREE.Vector3(scope.object.matrix.elements[0],
            scope.object.matrix.elements[1],
            scope.object.matrix.elements[2]);
        var y_axis = new THREE.Vector3(scope.object.matrix.elements[4],
            scope.object.matrix.elements[5],
            scope.object.matrix.elements[6]);
        var z_axis = new THREE.Vector3(scope.object.matrix.elements[8],
            scope.object.matrix.elements[9],
            scope.object.matrix.elements[10]);
        var offset = new THREE.Vector3();
        //x_axis.multiplyScalar(delta.y);
        offset.add(x_axis.multiplyScalar(delta.x).add(y_axis.multiplyScalar(delta.y).add(z_axis.multiplyScalar(delta.z))));
